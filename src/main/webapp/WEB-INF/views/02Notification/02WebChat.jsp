...
window.onload = function () {
	...
	/* 
	만약 웹브라우저가 웹소켓을 지원하지 않는다면 객체를
	생성할 수 없으므로 채팅을 사용할 수 없다. JS를 통해서 객체를 생성하고 있다.
	*/
...
function wsMessage(event) {
	...
	*/
	...
	if(content == ""){
		...
		// 내용에 아무것도 없다면 일반적인 메세지로 판단한다.
		}else{
			msg = makeBalloon(sender,content);
			// 대화창에 내용 출력하고 스크롤바 처리
			messageWindow.innerHTML += msg;
			messageWindow.scrollTop = messageWindow.scrollHeight;
...
// 상대방이 보낸 메세지를 UI 적용해서 출력하기 위한 부분
